...
- (void)viewDidLoad
{
    ...
    //        MBProgressHUD *hudSnap = [MBProgressHUD showHUDAddedTo:self.navigationController.view  animated:YES];
    //        hudSnap.labelText=@"Loading...";
    
    //        UIColor *DarkGreyOp = [UIColor orangeColor];
    //        UIColor *LightGreyOp = [UIColor colorWithRed:0.16 green:0.56 blue:0.76 alpha:1];
    
    //        UIColor *DarkGreyOp = [UIColor colorWithRed:0.85f green:0.6f blue:0.22f alpha:1.0];
    //        UIColor *LightGreyOp = [UIColor colorWithRed:0.93f green:0.74f blue:0.38f alpha:1.0];
    
    //    UIColor *DarkGreyOp = [UIColor colorWithRed:0.07f green:0.125f blue:0.35f alpha:1.0];
    //    UIColor *LightGreyOp = [UIColor colorWithRed:0.13f green:0.18f blue:0.45f alpha:0.8];
    //
    ...
    //    gradient2.frame = [[headingbut2 layer] bounds];
    ...
    //    gradient3.frame = [[headingbut3 layer] bounds];
    ...
    //                           nil];
    //
    //    [[headingbut1 layer] insertSublayer:gradient1 atIndex:0];
    //    [headingbut1 setTitleColor:[UIColor whiteColor] forState: UIControlStateNormal];
    //
    //    [[headingbut2 layer] insertSublayer:gradient2 atIndex:0];
    //    [headingbut2 setTitleColor:[UIColor whiteColor] forState: UIControlStateNormal];
    //
    //    [[headingbut3 layer] insertSublayer:gradient3 atIndex:0];
    //    [headingbut3 setTitleColor:[UIColor whiteColor] forState: UIControlStateNormal];
    
    
    //Below three blocks of border are commented by Ankit on 3/12/2106
    
    //headingbut1.layer.cornerRadius = 2;
    ...
    //headingbut2.layer.cornerRadius = 2;
    //headingbut2.layer.borderWidth = 1;
    //headingbut2.layer.borderColor = [UIColor colorWithRed:0.0f green:0.4784f blue:1.0f alpha:1].CGColor;
    
    //headingbut3.layer.cornerRadius = 2;
    //headingbut3.layer.borderWidth = 1;
    //headingbut3.layer.borderColor = [UIColor colorWithRed:0.0f green:0.4784f blue:1.0f alpha:1].CGColor;
