...
-(void)setupView {
	...
	// Set the font
	tickerFont = [UIFont fontWithName:@"Subway Ticker" size:13.0];
	...
	[tickerLabel setBackgroundColor:[UIColor blackColor]];
    [tickerLabel setTextColor:[UIColor yellowColor]];
        
    } else {
        //        load resources for ios7
        
        [tickerLabel setBackgroundColor:[UIColor clearColor]];
        [tickerLabel setTextColor:[UIColor darkGrayColor]];
